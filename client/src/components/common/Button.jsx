...
export const Button = ({
  ...
  const baseStyles = 'px-4 py-2 rounded-lg font-label-md flex items-center justify-center gap-2 transition-all active:scale-95 disabled:opacity-50 disabled:pointer-events-none';
...
Button.propTypes = {
  ...
  variant: PropTypes.oneOf(['primary', 'secondary', 'outline', 'error', 'ghost']),
