      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="bg-[#f1f3f5] border-b border-[#dee2e6]">
            <th className="px-6 py-4 font-bold text-label-md text-on-surface-variant uppercase tracking-wider">
              Employee ID
            </th>
            <th className="px-6 py-4 font-bold text-label-md text-on-surface-variant uppercase tracking-wider">
              Name
            ...
            <th className="px-6 py-4 font-bold text-label-md text-on-surface-variant uppercase tracking-wider text-right">
              Actions
            </th>
          </tr>
        </thead>
              ...
              >
                ...
                <td className="px-6 py-4">
                  {user.status === "ACTIVE" || user.status === "Active" ? (
                    <span className="bg-[#e7f5ea] text-[#1e7e34] px-3 py-1 rounded-full text-label-md font-bold">
                      Active
                    </span>
                  ) : (
                    <span className="bg-[#f8f9fa] text-outline px-3 py-1 rounded-full text-label-md font-bold border border-outline-variant">
                      Inactive
                    </span>
                  )}
                </td>
