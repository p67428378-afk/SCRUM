      ...
      <section className="hidden lg:flex flex-col w-1/2 bg-inverse-surface text-inverse-on-surface relative p-3xl overflow-hidden justify-between">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-lg mx-auto w-full my-auto">
          ...
          <h1 className="font-display-lg text-display-lg mb-md text-on-primary">
            Your Security is{" "}
            <span className="text-secondary-fixed">Our Priority</span>
          </h1>
          <p className="font-body-lg text-body-lg text-primary-fixed-dim mb-xl">
            Experience secure, scalable, and regulatorily compliant online
            banking.
          </p>

          {/* Feature List */}
          <ul className="text-left space-y-md font-body-md text-body-md text-inverse-on-surface w-full max-w-md">
            <li className="flex items-start">
              <span
                className="material-symbols-outlined text-secondary-fixed mr-sm flex-shrink-0"
                style={{ fontVariationSettings: "'FILL' 1" }}
              >
                check_circle
              </span>
              <span>FFIEC Compliant Multi-Factor Authentication</span>
            </li>
            <li className="flex items-start">
              <span
                className="material-symbols-outlined text-secondary-fixed mr-sm flex-shrink-0"
              ...
              <span>GLBA Protected Customer Data</span>
            </li>
            <li className="flex items-start">
              <span
                className="material-symbols-outlined text-secondary-fixed mr-sm flex-shrink-0"
              ...
              <span>PCI DSS Certified Transaction Security</span>
            </li>
            <li className="flex items-start">
              <span
                className="material-symbols-outlined text-secondary-fixed mr-sm flex-shrink-0"
              ...
              <span>256-bit AES Data Encryption at Rest &amp; in Transit</span>
            </li>
          </ul>
        </div>
