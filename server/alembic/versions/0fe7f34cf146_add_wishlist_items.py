...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_user_activity_logs_endpoint'), 'user_activity_logs', ['endpoint'], unique=False)
    op.create_index(op.f('ix_user_activity_logs_user_id'), 'user_activity_logs', ['user_id'], unique=False)
    op.create_table('user_login_stats',
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('user_id', sa.String(length=36), nullable=False),
    ...
    op.create_index(op.f('ix_user_login_stats_user_id'), 'user_login_stats', ['user_id'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_user_activity_logs_endpoint'), table_name='user_activity_logs')
