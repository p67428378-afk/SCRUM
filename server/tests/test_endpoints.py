...
def test_verify_otp_and_activate_alert():
    ...
    db = TestingSessionLocal()
    otp_tx = db.query(models.OTPTransaction).filter_by(otp_reference_id=otp_ref_id).first()
...
def test_daily_spend_exceeds_threshold_triggers_sms():
    ...
    spend_response_2 = client.post("/api/v1/alerts/simulate-spend", json=spend_payload_2)
    ...
    assert "exceeding your configured threshold of 5000.00 INR" in spend_data_2["message"]
